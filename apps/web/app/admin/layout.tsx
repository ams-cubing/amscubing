      ...
      <section className="border-b border-black/10 bg-ams-navy py-10 text-white">
        <div className="ams-container max-w-280">
          ...
          <p className="ams-copy mt-3 max-w-2xl text-base leading-7 text-white/75">
            Gestiona perfiles públicos de delegados, roles editoriales, la
            allowlist piloto de Tableros y las publicaciones en redes.
          </p>
...
function AdminShellFallback() {
  return (
    <div className="ams-container max-w-280 space-y-4 py-16" aria-hidden>
      <div className="h-8 w-64 animate-pulse rounded bg-ams-soft" />
      <div className="h-4 w-96 animate-pulse rounded bg-ams-soft" />
      <div className="h-64 w-full animate-pulse rounded-5.5 bg-ams-soft" />
    </div>
  );
}
