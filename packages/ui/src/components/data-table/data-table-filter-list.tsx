        ...
        >
          <div className="flex flex-col gap-1">
            <h4 id={labelId} className="font-medium leading-none">
              {filters.length > 0 ? "Filtros" : "Sin filtros aplicados"}
            </h4>
            <p
              id={descriptionId}
              className={cn(
            ...
            >
              {filters.length > 0
                ? "Modifica los filtros para refinar tus filas."
                : "Agrega filtros para refinar tus filas."}
            </p>
          </div>
          {filters.length > 0 ? (
      ...
      >
        <div className="min-w-18 text-center">
          {index === 0 ? (
            ...
            >
              <SelectTrigger
                aria-label="Seleccionar operador de unión"
      ...
      return (
        ...
        >
          <SelectTrigger
            ...
            aria-label={`${columnMeta?.label} filtro booleano`}
            size="sm"
        ...
        >
          <FacetedTrigger asChild>
            <Button
              id={inputId}
              aria-controls={inputListboxId}
              aria-label={`valor${multiple ? "es" : ""} del filtro de ${columnMeta?.label}`}
              variant="outline"
              size="sm"
            ...
            >
              <FacetedBadgeList
                ...
                placeholder={
                  ...
                  `Seleccionar opción${multiple ? "es" : ""}...`
                }
              />
            </Button>
          </FacetedTrigger>
        ...
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          <PopoverTrigger asChild>
            <Button
              id={inputId}
              aria-controls={inputListboxId}
              aria-label={`${columnMeta?.label} filtro de fecha`}
              variant="outline"
              size="sm"
              className={cn(
          ...
          >
            {filter.operator === "isBetween" ? (
              <Calendar
                aria-label={`Seleccionar rango de fechas de ${columnMeta?.label}`}
                autoFocus
              ...
              <Calendar
                aria-label={`Seleccionar fecha de ${columnMeta?.label}`}
                autoFocus
                captionLayout="dropdown"
                mode="single"
                selected={
