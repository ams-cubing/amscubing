        ...
        <CommandGroup>
          ...
          >
            {isEmpty ? (
              <>
                <Text />
                <span>Escribe para agregar filtro...</span>
              </>
            ) : (
              <>
                <BadgeCheck />
  ...
  if (filter.operator === "isEmpty" || filter.operator === "isNotEmpty") {
    return (
      <div
        id={inputId}
        role="status"
        aria-label={`${column.columnDef.meta?.label} filtro es ${
          filter.operator === "isEmpty" ? "vacío" : "no vacío"
        }`}
        aria-live="polite"
    ...
    case "range": {
      ...
      return (
        <Input
          ...
          placeholder={
            column.columnDef.meta?.placeholder ?? "Ingresar valor..."
          }
